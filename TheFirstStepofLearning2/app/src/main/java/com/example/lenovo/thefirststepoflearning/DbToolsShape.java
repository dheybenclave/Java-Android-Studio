...
public class DbToolsShape extends SQLiteOpenHelper {
    private Context contex;
    private static int version =3;
    private static String dbName = "DBUsersShape";
    public String tblLists = "tblUsersShape";
    ...
    public DbToolsShape(Context appContext){
