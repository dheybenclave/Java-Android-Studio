...
/**
 * Created by Dragonaire on 10/15/2017.
 */

public class DbToolsLetters extends SQLiteOpenHelper {
    private Context contex;
    private static int version =3;
    private static String dbName = "DBUsersLetters";
    public String tblLists = "tblUsersLetters";
    ...
    public DbToolsLetters(Context appContext){
