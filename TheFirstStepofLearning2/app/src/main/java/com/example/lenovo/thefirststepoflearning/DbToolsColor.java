...
public class DbToolsColor extends SQLiteOpenHelper {
    private Context contex;
    private static int version =3;
    private static String dbName = "DBUsersCol";
    public String tblLists = "tblUsersCol";
    ...
    public DbToolsColor(Context appContext){
