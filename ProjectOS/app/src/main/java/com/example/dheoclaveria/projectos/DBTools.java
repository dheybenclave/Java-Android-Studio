...
//////////////////////////////////////////////////
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        query = "INSERT INTO " + tbl_name + " ( " + fld_title + "," + fld_subjectname + "," + fld_description + "," + fld_keyword + "," + fld_date + "," + fld_time + "," + fld_image + " ) " +
    ...
    public Cursor getsingleDataid(int id) {

        String query = "SELECT * FROM " + tbl_name + " WHERE " + tbl_name + " = " + id;
        return db.rawQuery(query, null);
    }
    public Cursor getsingleDatasub(String subjectname) {

        String query = "SELECT * FROM " + tbl_name + " WHERE " + fld_subjectname + " = '" + subjectname+"' ;" ;
    ...
    public long updatesubject(int id,String title, String image, String color) {
        ...
        long success = db.update(tbl_subjectname,values, sn_id + "=?", new String[]{id + ""});
        return success;
